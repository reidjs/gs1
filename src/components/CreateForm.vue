<template>
  <form class="bg-white shadow overflow-hidden sm:rounded-lg space-y-8 divide-y divide-gray-200">
    <div class="px-4 py-5 sm:px-6 space-y-8 divide-y divide-gray-200 sm:space-y-5">
      <div>
        ...
        <div>
          <h3 class="text-md leading-6 font-medium text-gray-400">Upload data from file</h3>
