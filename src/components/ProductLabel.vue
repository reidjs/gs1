      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 flex justify-between sm:px-6">
          ...
          <div class="flex items-center justify-center flex-col">
            <QrcodeVue :value="route" class="" />
            <p class="text-center text-sm">Scan to view online</p>
          </div>
        </div>
        <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 grid-cols-2">
            <div class="">
              <dt class="text-sm font-medium text-gray-500">Strain</dt>
              <dd class="mt-1 text-sm text-gray-900">
                {{ product.productName }}
              </dd>
            </div>
            <div class="">
              <dt class="text-sm font-medium text-gray-500">Percentage THC</dt>
              <dd class="mt-1 text-sm text-gray-900">
                {{ product.thcPercentage }}
              </dd>
            </div>
            <div class="">
              <dt class="text-sm font-medium text-gray-500">Volume CBD</dt>
              <dd class="mt-1 text-sm text-gray-900">3.9mg</dd>
            </div>
            <div class="">
              <dt class="text-sm font-medium text-gray-500">Tested By</dt>
              <dd class="mt-1 text-sm text-gray-900">ACT Labs</dd>
            </div>
          </dl>
        </div>
        <div class="flex w-full p-4">
          <div class="text-xs">
            WARNING: As part of these actions, FDA has tested the chemical
            content of cannabinoid compounds in some of the products, and many
            were found to not contain the levels of CBD they claimed to contain.
            ...
            disease. Consumers should beware purchasing and using any such
            products.
          </div>
        </div>
      </div>
